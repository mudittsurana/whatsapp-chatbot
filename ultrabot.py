...
class ultraChatBot():    
    def __init__(self, json):
        ...
        self.ultraAPIUrl = 'https://api.ultramsg.com/instance69068/'
        self.token = 'ka8i7e3i4q9yq4ud'
        self.text_api_url = 'https://api-inference.huggingface.co/models/Qiaozhen/fake-news-detector'
        self.image_api_url = 'https://api-inference.huggingface.co/models/NehaBardeDUKE/autotrain-ai-generated-image-classification-3250490787'

        bearer = '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'
        self.headers = {"Authorization": f"Bearer {bearer}"}

        self.video_api_url = ('http://127.0.0.1:7860/')
        self.video_client = Client('http://127.0.0.1:7860/')
...
Welcome to *Sach ka sathi* — An AI-Powered Reality Check for Social Media. 🕵️‍♀️
...
Thanks! 😊"""
        ...
        if label == "Artificial":
            res_msg = """⚠️ *Attention!* ⚠️ 
The image you sent appears to be a ai generated image 🤖 and not a real photo. 
Be aware! 🔍"""

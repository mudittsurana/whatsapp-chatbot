...
title=" Deepfakes Video Detector"
description="This is a implementation of EfficientNetV2 Deepfakes Image Detector by using frame-by-frame detection. \
            To use it, simply upload your video, or click one of the examples to load them.\
            This demo and model represent the Third Year Project titled \"Fake News Detection Using EfficientNetV2\" by a CS undergraduate team. \
            ...
            The examples are used under fair use to demo the working of the model only. If any copyright is infringed, please contact the researcher via this email: hardiksinghbhatneria@gmail.com.\
            "
...
examples = [              
                ...
                ['real-1.mp4'],
                ['fake-1.mp4'],
                ['obama-fake-trump.mp4']
           ]
           
gr.Interface(deepfakespredict,
                     inputs = ["video"],
                     outputs=["text","text", gr.Label(label="Detected face sequence")],
                     title=title,
